...
export default class FactoryPipe extends ModelPipe {
    ...
    seedStatement(attribute) {
        let typeMap = {
            ...
            tinyInteger: { default: "rand(0, 10)"},
            integer: { default: "rand(0, 10)"},
            smallInteger: { default: "rand(0, 10)"},
            mediumInteger: { default: "rand(0, 10)"},
            bigInteger: { default: "rand(0, 10)"},
            unsignedInteger: { default: "rand(0, 10)"},
            unsignedMediumInteger: { default: "rand(0, 10)"},
            unsignedSmallInteger: { default: "rand(0, 10)"},
            unsignedTinyInteger: { default: "rand(0, 10)"},
            unsignedBigInteger: { default: "rand(0, 10)"},
